...
Skybox::Skybox() : Model() {
	...
	skyTextureID = 1;
	cubeMap("../Assets/Textures/negz.tga","../Assets/Textures/posz.tga","../Assets/Textures/negy.tga", "../Assets/Textures/posy.tga",
			"../Assets/Textures/negx.tga", "../Assets/Textures/posx.tga", &skyTextureID);
